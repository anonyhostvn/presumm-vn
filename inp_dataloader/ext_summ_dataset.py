...
class ExtSummDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        src_inp_ids, src_tok_type_ids, src_lis_cls_pos, src_mask, ext_ids = torch.load(file_path)
        return src_inp_ids, src_tok_type_ids, src_lis_cls_pos, src_mask, ext_ids
